    ...
    <div className="row-2">
      <div className="article-container">
        <div className="article">
          ...
          <h4 className="title">
            Referees Storm off the Field After Heated Conflict with The Texans
            Offense
          </h4>
          <p className="Summary">
            The officials for the game got into a dispute with the Texans
            Quarterback Dave Mills after an unsportsmanlike conduct, in which
            the rookie did his "new and special" dance move, lets just say it
            wasn't so special.
          </p>
          <p className="author">
            <small className="muted">J. Golden Ellis</small>
          </p>
        </div>
        <div className="article">
          <img className="article-image" src={AB}></img>
          <h4 className="title">
            Antonio Brown vs Logan Paul, We all Know Who We Want to Win
          </h4>
          <p className="Summary">
            With the much anticipated fight on the line, bets started piling up
            in Antonio's favor especially with his recent charges for battery
            and burglary, we can only hope that Antonio will do the same to
            Logan.
          </p>
          <p className="author">
            <small className="muted">Ethan Kaloi</small>
          </p>
        </div>
      </div>
        ...
        <ul className="top-headlines">
          ...
          <li>
            <a className="headline">
              Oregon Ducks football association banned from PAC-12
            </a>
          </li>
        </ul>
